    ...
    internal class MilitaryClock
    {
        ...
        static void multiThread()
        {
            while (isActive)
            {
                ...
                {
                    case ConsoleKey.Tab:
                        MilitaryClock.isActive = false;
                        AMPMClock.isActive = true;
                        Console.Clear();
                        AMPMClock.Run();
                        break;
        ...
        static void RenderTime(int x, int y)
        {
            ...
            for (int i = 0; i < time.Length; i++)
            {
                ...
                // If the character is anything other than a colon, then render the segment of the display
                else
                {
        ...
        public static Segment GetSegment(char c)
        {
            ...
            {
                case '0':
                    return new Segment { A = true, B = true, C = true, D = true, E = true, F = true, G = false };
                case '1':
                    return new Segment { A = false, B = true, C = true, D = false, E = false, F = false, G = false };
                case '2':
                    return new Segment { A = true, B = true, C = false, D = true, E = true, F = false, G = true };
                case '3':
                    return new Segment { A = true, B = true, C = true, D = true, E = false, F = false, G = true };
                case '4':
                    return new Segment { A = false, B = true, C = true, D = false, E = false, F = true, G = true };
                case '5':
                    return new Segment { A = true, B = false, C = true, D = true, E = false, F = true, G = true };
                case '6':
                    return new Segment { A = true, B = false, C = true, D = true, E = true, F = true, G = true };
                case '7':
                    return new Segment { A = true, B = true, C = true, D = false, E = false, F = false, G = false };
                case '8':
                    return new Segment { A = true, B = true, C = true, D = true, E = true, F = true, G = true };
                case '9':
                    return new Segment { A = true, B = true, C = true, D = true, E = false, F = true, G = true };
                default:
                    return new Segment { A = false, B = false, C = false, D = false, E = false, F = false, G = false };
            }
        }
